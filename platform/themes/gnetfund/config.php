    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme)
        {
            ...
            $theme->asset()->container('footer')
                ->usePath()->add('jquery', 'js/jquery-3.4.1.min.js')
                ->usePath()->add('popper', 'js/popper.min.js')
                ->usePath()->add('bootstrap', 'js/bootstrap.min.js')
                ->usePath()->add('amcharts-core', 'js/amcharts-core.min.js')
                ->usePath()->add('amcharts', 'js/amcharts.min.js')
                ->usePath()->add('mCustomScrollbar', 'js/jquery.mCustomScrollbar.js')
